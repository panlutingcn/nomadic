...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const [imprints, setImprints] = useState<Imprint[]>([
    { id: 'my-1', city: 'Berlin', title: 'Markthalle IX 的一个下午', narrative: '柏林人对空间再利用的想象力让我重新思考创意的边界。', tags: ['柏林', '创意'], isPublic: true, likes: 12, createdAt: '2026.03.18' },
    { id: 'my-2', city: 'Amsterdam', title: '约旦区的周六早市', narrative: '阿姆斯特丹人把生活过得像一门手艺，每一个摊位背后都是一个认真经营的小世界。', tags: ['阿姆斯特丹', '生活方式'], isPublic: false, createdAt: '2026.02.05' },
    { id: 'my-3', city: 'Lisbon', title: '里斯本的第一杯 Ginjinha', narrative: '在阿尔法玛区迷路的那个傍晚，我突然明白为什么这么多人选择留下来。', tags: ['里斯本', '慢生活'], isPublic: true, likes: 8, createdAt: '2026.01.30' },
    { id: 'my-4', city: 'Prague', title: '布拉格的咖啡馆工作日', narrative: '一杯咖啡，三小时，窗外是中世纪的屋顶。效率反而比在办公室高了三倍。', tags: ['布拉格', '远程工作'], isPublic: false, createdAt: '2025.12.10' },
    { id: 'my-5', city: 'Tallinn', title: '塔林老城的数字游民聚会', narrative: '在这里遇见了来自十二个国家的人，大家都在用笔记本电脑改变世界，却住在中世纪的石头房子里。', tags: ['塔林', '社群'], isPublic: true, likes: 21, createdAt: '2025.11.22' },
  ])
