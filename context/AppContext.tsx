...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const [imprints, setImprints] = useState<Imprint[]>([
    ...
    { id: 'my-5', city: 'Tallinn', title: '塔林老城的数字游民聚会', narrative: '在这里遇见了来自十二个国家的人，大家都在用笔记本电脑改变世界，却住在中世纪的石头房子里。', tags: ['塔林', '社群'], isPublic: true, likes: 21, createdAt: '2025.11.22', photo: 'https://images.unsplash.com/photo-1553913861-c0fddf2619ee?auto=format&fit=crop&w=600&q=80' },
  ])
